...
<head>
  ...
  <link href="../css/styleConsejos.css" rel="stylesheet" />
</head>
...
<body>
    ...
    <div class="row px-xl-5">
      <div class="col-12">
        <nav class="breadcrumb bg-light mb-30">
          ...
          <span class="breadcrumb-item active">Consejos</span>
        </nav>
      </div>
    </div>
  </div>
  ...
  <div class="container-fluid pt-5 pb-3">
    <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4">
      <span class="bg-secondary pr-3">Sesión de Consejos</span>
    </h2>
    <div class="demo">
      <div class="container">
        <div class="row">
          <div class="col-md-3 col-sm-6">
            <div class="pricingTable">
              <div class="pricingTable-header">
                <h3 class="heading">Consejo para el</h3>
                <span class="price-value">
                  <h3 class="heading">Aceite</h3>
                </span>
              </div>
              <div class="pricing-content">
                <ul>
                  <li>
                    ...
                    Alias voluptates minima nesciunt omnis! Sed nemo magnam
                    hic neque cupiditate consequuntur.
                  </li>
                  <li>
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                    Alias voluptates minima nesciunt omnis! Sed nemo magnam
                ...
                <div class="posit"><a href="" class="read">Ir</a></div>
              </div>
            </div>
          </div>
          <div class="col-md-3 col-sm-6">
            <div class="pricingTable">
              <div class="pricingTable-header">
                <h3 class="heading">Consejo para la</h3>
                <span class="price-value">
                  <h3 class="heading">bateria</h3>
                </span>
              </div>
              <div class="pricing-content">
                <ul>
                ...
                <div class="posit">
                  <a href="servicosMacanicos.php" class="read">Ir</a>
                </div>
              </div>
            </div>
          </div>
          <div class="col-md-3 col-sm-6">
            <div class="pricingTable">
              ...
              <div class="pricing-content">
                ...
                <div class="posit">
                  <a href="ProductosyRepuestos.php" class="read">Ir</a>
                </div>
              </div>
            </div>
          </div>
          <div class="col-md-3 col-sm-6">
            <div class="pricingTable">
              <div class="pricingTable-header">
                <h3 class="heading">Consejo para las</h3>
                <span class="price-value">
                  <h3 class="heading">llantas</h3>
                </span>
              </div>
              <div class="pricing-content">
                <ul>
