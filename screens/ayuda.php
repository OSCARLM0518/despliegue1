...
<head>
  ...
  <link href="../css/styleAyuda.css" rel="stylesheet" />
</head>
...
<body>
    ...
    <div class="row px-xl-5">
      <div class="col-12">
        <nav class="breadcrumb bg-light mb-30">
          ...
          <span class="breadcrumb-item active">Ayuda</span>
        </nav>
      </div>
    </div>
  </div>
  ...
  <div class="container-fluid pt-5 pb-3">
    <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4">
      <span class="bg-secondary pr-3">Sesión de ayuda</span>
    </h2>
    <div class="demo">
      <div class="container">
        <div class="row">
          <div class="col-md-3 col-sm-6">
            <div class="pricingTable">
              <div class="pricingTable-header">
                <h3 class="heading">Encontrar</h3>
                <span class="price-value">
                  <h3 class="heading">mecanicos</h3>
                </span>
              </div>
          ...
          <div class="col-md-3 col-sm-6">
            <div class="pricingTable">
              <div class="pricingTable-header">
                <h3 class="heading">Encontrar</h3>
                <span class="price-value">
                  <h3 class="heading">servicos mecanicos</h3>
                </span>
              </div>
              <div class="pricing-content">
                <ul>
