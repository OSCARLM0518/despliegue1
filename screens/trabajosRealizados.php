...
<head>
  ...
  <link href="../css/styleTrabajos.css" rel="stylesheet" />
</head>
...
<body>
    ...
    <div class="row px-xl-5">
      <div class="col-12">
        <nav class="breadcrumb bg-light mb-30">
          ...
          <span class="breadcrumb-item active">trabajos Realizados</span>
        </nav>
      </div>
    </div>
  </div>
  ...
  <div class="container-fluid pt-5 pb-3">
    <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4">
      <span class="bg-secondary pr-3">Trabajos realizados por el mecanico Jose</span>
    </h2>
    <div class="container-card">
      <div class="card">
        <figure>
          <img src="img/manteni1.jpg" />
        </figure>
        <div class="contenido-card">
          <h3>Mantenimiento general</h3>
          <p>
            Me encargo de las tareas regulares como cambio de aceite, revisión
            de frenos y ajuste de cadenas para mantener la motocicleta en
      ...
      <div class="card">
        <figure>
          <img src="img/elec1.jpg" />
        </figure>
        <div class="contenido-card">
          <h3>Reparación eléctrica</h3>
          <p>
            Soluciono problemas relacionados con el sistema eléctrico de la
            moto, como fallos en luces, batería o el sistema de encendido,
            asegurando un rendimiento fiable y seguro.
          </p>
          <div class="per">
            <a href="AgendarCitas.php">¡ CONTRATAR MECANICO !</a>
          </div>
      ...
      <div class="card">
        <figure>
          <img src="img/motor1.jpg" />
        </figure>
        <div class="contenido-card">
          <h3>Reparación de motor</h3>
          <p>
            Me focalizo en la corrección de fallos mecánicos del motor, desde
            la reparación de averías menores hasta la reconstrucción completa
            del motor para restaurar su rendimiento y durabilidad.
          </p>
          <div class="exp">
            <a href="AgendarCitas.php">¡ CONTRATAR MECANICO !</a>
          </div>
  ...
  <div class="container-fluid pt-5 pb-3">
    <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4">
      <span class="bg-secondary pr-3">Trabajos realizados por el mecanico Alex</span>
    </h2>
    <div class="container-card">
      <div class="card">
        <figure>
          <img src="img/manteni2.jpg" />
        </figure>
        <div class="contenido-card">
          <h3>Mantenimiento general</h3>
          <p>
  ...
  <div class="container-fluid pt-5 pb-3">
    <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4">
      <span class="bg-secondary pr-3">Trabajos realizados por el mecanico Manuel</span>
    </h2>
    <div class="container-card">
      <div class="card">
        <figure>
          <img src="img/manteni3.jpg" />
        </figure>
        <div class="contenido-card">
          <h3>Mantenimiento general</h3>
          <p>
  ...
  <div class="container-fluid pt-5 pb-3">
    <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4">
      <span class="bg-secondary pr-3">Trabajos realizados por el mecanico Richard</span>
    </h2>
    <div class="container-card">
      <div class="card">
        <figure>
          <img src="img/manteni4.jpg" />
        </figure>
        <div class="contenido-card">
          <h3>Mantenimiento general</h3>
          <p>
